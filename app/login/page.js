  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <p style={{ color: TEXT_FAINT }} className="text-xs text-center mt-5 leading-relaxed">
          เมื่อเข้าสู่ระบบ ระบบจะบันทึกชื่อและอีเมลของคุณไว้เพื่อผูกข้อมูลบันทึกกับบัญชีของคุณเท่านั้น
        </p>
      </div>
    </div>
  );
